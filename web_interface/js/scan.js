...
function drawScan() {
	...
	for (var i = 0; i < scanJson.aps.length; i++) {
		...
		html += (selected ? "<tr class='selected'>" : "<tr>") +
			...
			+
			"<td class='name'>" + (scanJson.aps[i][1].length > 0 ? esc(scanJson.aps[i][1]) : "<button class='button-hover' onclick='add(0," + i + ")'>" + lang("add") + "</button>") + "</td>" // Name
			+
	...
	for (var i = 0; i < scanJson.stations.length; i++) {
		...
		html += (selected ? "<tr class='selected'>" : "<tr>") +
			...
			+
			"<td class='name'>" + (scanJson.stations[i][2].length > 0 ? esc(scanJson.stations[i][2]) : "<button class='button-hover' onclick='add(1," + i + ")'>" + lang("add") + "</button>") + "</td>" // Name
			+
...
function drawNames() {
	...
	for (var i = 0; i < nameJson.length; i++) {
		...
		html += (selected ? "<tr class='selected'>" : "<tr>") +
			...
			+
			"<td class='save'><button class='button-hover' onclick='save(" + i + ")'>" + lang("save") + "</button></td>" // Save
			// Select
			+
