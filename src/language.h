...
const char CLI_SAVE_GMAIL_CREDENTIAL[] PROGMEM = "savegmail";
...
const char CLI_GMAIL_CREDENTIAL[] PROGMEM = "gmail";
...
const char D_CAPTIVE_PORTAL_ON_WITH_GMAIL[] PROGMEM = "with gmail";
